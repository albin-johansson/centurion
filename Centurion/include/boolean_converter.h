...
/**
\brief The BooleanConverter class is a conversion tool between values of bool and SDL_bool.
*/
...
public:
	...
	/**
	\brief Converts an SDL_bool value and returns the corresponding default C++ bool value.
