...
typedef std::shared_ptr<centurion::input::MouseListener> MouseListener_sptr;
typedef std::unique_ptr<centurion::input::MouseListener> MouseListener_uptr;
typedef std::weak_ptr<centurion::input::MouseListener> MouseListener_wptr;
