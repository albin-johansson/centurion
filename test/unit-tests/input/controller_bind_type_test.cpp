...
{
  ASSERT_EQ(cen::ToUnderlying(cen::controller_bind_type::axis), SDL_CONTROLLER_BINDTYPE_AXIS);
  ASSERT_EQ(cen::ToUnderlying(cen::controller_bind_type::button),
            SDL_CONTROLLER_BINDTYPE_BUTTON);
  ASSERT_EQ(cen::ToUnderlying(cen::controller_bind_type::none), SDL_CONTROLLER_BINDTYPE_NONE);
  ASSERT_EQ(cen::ToUnderlying(cen::controller_bind_type::hat), SDL_CONTROLLER_BINDTYPE_HAT);
}
