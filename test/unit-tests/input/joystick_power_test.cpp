...
{
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::unknown), SDL_JOYSTICK_POWER_UNKNOWN);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::empty), SDL_JOYSTICK_POWER_EMPTY);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::low), SDL_JOYSTICK_POWER_LOW);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::medium), SDL_JOYSTICK_POWER_MEDIUM);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::full), SDL_JOYSTICK_POWER_FULL);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::wired), SDL_JOYSTICK_POWER_WIRED);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_power::max), SDL_JOYSTICK_POWER_MAX);
}
