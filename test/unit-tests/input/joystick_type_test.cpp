...
{
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::unknown), SDL_JOYSTICK_TYPE_UNKNOWN);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::game_controller),
            SDL_JOYSTICK_TYPE_GAMECONTROLLER);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::wheel), SDL_JOYSTICK_TYPE_WHEEL);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::arcade_stick),
            SDL_JOYSTICK_TYPE_ARCADE_STICK);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::flight_stick),
            SDL_JOYSTICK_TYPE_FLIGHT_STICK);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::dance_pad), SDL_JOYSTICK_TYPE_DANCE_PAD);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::guitar), SDL_JOYSTICK_TYPE_GUITAR);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::drum_kit), SDL_JOYSTICK_TYPE_DRUM_KIT);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::arcade_pad), SDL_JOYSTICK_TYPE_ARCADE_PAD);
  ASSERT_EQ(cen::ToUnderlying(cen::joystick_type::throttle), SDL_JOYSTICK_TYPE_THROTTLE);
}
