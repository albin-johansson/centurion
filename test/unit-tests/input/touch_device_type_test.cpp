...
TEST(TouchDeviceType, Values)
{
  ...
  ASSERT_EQ(cen::touch_device_type::indirect_absolute,
            SDL_TOUCH_DEVICE_INDIRECT_ABSOLUTE);
  ASSERT_EQ(cen::touch_device_type::indirect_relative,
  ...
  ASSERT_EQ(SDL_TOUCH_DEVICE_INDIRECT_ABSOLUTE,
            cen::touch_device_type::indirect_absolute);
  ASSERT_EQ(SDL_TOUCH_DEVICE_INDIRECT_RELATIVE,
            cen::touch_device_type ::indirect_relative);
...
{
  ASSERT_THROW(cen::to_string(static_cast<cen::touch_device_type>(4)), cen::cen_error);

  ASSERT_EQ("invalid", cen::to_string(cen::touch_device_type::invalid));
  ASSERT_EQ("direct", cen::to_string(cen::touch_device_type::direct));
  ASSERT_EQ("indirect_absolute",
            cen::to_string(cen::touch_device_type::indirect_absolute));
