...
TEST(PixelFormat, Values)
{
  ...
  ASSERT_EQ(to_underlying(Format::Index1LSB), SDL_PIXELFORMAT_INDEX1LSB);
  ASSERT_EQ(to_underlying(Format::Index1MSB), SDL_PIXELFORMAT_INDEX1MSB);
  ASSERT_EQ(to_underlying(Format::Index4LSB), SDL_PIXELFORMAT_INDEX4LSB);
  ASSERT_EQ(to_underlying(Format::Index4MSB), SDL_PIXELFORMAT_INDEX4MSB);
  ...
  ASSERT_EQ(to_underlying(Format::ExternalOES), SDL_PIXELFORMAT_EXTERNAL_OES);
}
