...
{
  ASSERT_THROW(cen::to_string(static_cast<cen::screen_orientation>(6)), cen::Error);
  ...
  ASSERT_EQ("landscape_flipped", cen::to_string(cen::screen_orientation::landscape_flipped));
  ASSERT_EQ("portrait", cen::to_string(cen::screen_orientation::portrait));
  ASSERT_EQ("portrait_flipped", cen::to_string(cen::screen_orientation::portrait_flipped));
