...
TEST_CASE("DeviceType enum", "[Touch]")
{
  SECTION("Operator ==")
  {
    ...
    CHECK(
        !(DeviceType::IndirectAbsolute == SDL_TOUCH_DEVICE_DIRECT));  // NOLINT
  }
